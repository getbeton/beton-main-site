...
integrations:
  ...
  - "pipedrive"
faq:
  - question: "What's the difference between Beton's PQL detection and a standard HubSpot lead score?"
    answer: "HubSpot lead scoring requires you to define point thresholds for each behavior. Beton looks at the cohort of users who actually converted to paid in your product and surfaces the behavioral combinations that predict conversion. The output is a routed signal, not a number — and it adapts as your product changes."
  - question: "Does Beton replace our PostHog dashboards?"
    answer: "No. PostHog stays the source of truth for product analytics; Beton sits on top and routes signals derived from that data into the CRM. The PostHog dashboards your product team uses are unchanged."
  - question: "What CRMs does Beton route PQL signals to?"
    answer: "Attio, HubSpot, Zoho, and Pipedrive natively. Anything else via webhook destinations (Customer.io, Slack, internal tools, Salesforce via webhook bridges)."
  - question: "How long does it take to see the first PQL signal after connecting Beton?"
    answer: "Most teams see their first signal in their CRM within an hour of connecting a PostHog instance. The heuristic needs at least one converter cohort to compare against, which usually exists already in your historical data."
  - question: "Can we self-host Beton for PQL qualification?"
    answer: "Yes. Beton is open source under AGPLv3. Self-hosted runs free with your own LLM key. The hosted cloud is $0.50 per tracked user per month with a free trial."
  - question: "What if our product is changing too fast for any PQL definition to stay valid?"
    answer: "That's actually the case Beton is built for. The detection runs against the most recent converter cohort on a rolling basis, so when a release shifts what 'engaged' looks like, the heuristic moves with it. Static rules in HubSpot don't."
seo:
