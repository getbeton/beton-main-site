...
For every tool that had a published 2023 pricing page — 17 of the 20 — here is the 2023-to-2026 delta. Each 2023 figure is quoted from an archived snapshot of that vendor's pricing page (source links are in the [data repo](https://github.com/getbeton/oss-pricing-data)). Langfuse, Firecrawl, and Coolify had no 2023 pricing page and are new to this volume.
...
<svg viewBox="0 0 500 564" role="img" aria-label="Entry price, 2023 vs 2026, for every tool with a comparable flat/seat price in both years (sorted by 2026 price). Verified against Wayback snapshots. Usage-priced tools (PostHog, ClickHouse) and tools unpriced in 2023 (Plane, Temporal) are excluded." style="width:100%;height:auto;font-family:Inter, ui-sans-serif, system-ui, -apple-system, sans-serif"><rect x="110" y="6" width="14" height="14" fill="var(--color-text-tertiary)" rx="1"></rect><text x="130" y="17" fill="var(--color-text-secondary)" font-size="13">2023</text><rect x="180" y="6" width="14" height="14" fill="var(--color-primary-600)" rx="1"></rect><text x="200" y="17" fill="var(--color-text-secondary)" font-size="13">2026</text><text x="0" y="52" fill="var(--color-text)" font-size="14">Twenty CRM</text><rect x="110" y="30" width="87" height="15" fill="var(--color-text-tertiary)" rx="1"></rect><text x="204" y="42" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$29</text><rect x="110" y="48" width="27" height="15" fill="var(--color-primary-600)" rx="1"></rect><text x="144" y="60" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$9</text><text x="0" y="96" fill="var(--color-text)" font-size="14">Cal.com</text><rect x="110" y="74" width="36" height="15" fill="var(--color-text-tertiary)" rx="1"></rect><text x="153" y="86" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$12</text><rect x="110" y="92" width="36" height="15" fill="var(--color-primary-600)" rx="1"></rect><text x="153" y="104" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$12</text><text x="0" y="140" fill="var(--color-text)" font-size="14">Appsmith</text><rect x="110" y="118" width="60" height="15" fill="var(--color-text-tertiary)" rx="1"></rect><text x="177" y="130" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$20 cap</text><rect x="110" y="136" width="45" height="15" fill="var(--color-primary-600)" rx="1"></rect><text x="162" y="148" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$15</text><text x="0" y="184" fill="var(--color-text)" font-size="14">Grafana</text><rect x="110" y="162" width="87" height="15" fill="var(--color-text-tertiary)" rx="1"></rect><text x="204" y="174" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$29</text><rect x="110" y="180" width="57" height="15" fill="var(--color-primary-600)" rx="1"></rect><text x="174" y="192" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$19</text><text x="0" y="228" fill="var(--color-text)" font-size="14">Chatwoot</text><rect x="110" y="206" width="57" height="15" fill="var(--color-text-tertiary)" rx="1"></rect><text x="174" y="218" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$19</text><rect x="110" y="224" width="57" height="15" fill="var(--color-primary-600)" rx="1"></rect><text x="174" y="236" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$19</text><text x="0" y="272" fill="var(--color-text)" font-size="14">ToolJet</text><rect x="110" y="250" width="72" height="15" fill="var(--color-text-tertiary)" rx="1"></rect><text x="189" y="262" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$24</text><rect x="110" y="268" width="57" height="15" fill="var(--color-primary-600)" rx="1"></rect><text x="174" y="280" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$19</text><text x="0" y="316" fill="var(--color-text)" font-size="14">Infisical</text><rect x="110" y="294" width="18" height="15" fill="var(--color-text-tertiary)" rx="1"></rect><text x="135" y="306" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$6</text><rect x="110" y="312" width="54" height="15" fill="var(--color-primary-600)" rx="1"></rect><text x="171" y="324" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$18</text><text x="0" y="360" fill="var(--color-text)" font-size="14">Windmill</text><rect x="110" y="338" width="30" height="15" fill="var(--color-text-tertiary)" rx="1"></rect><text x="147" y="350" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$10</text><rect x="110" y="356" width="60" height="15" fill="var(--color-primary-600)" rx="1"></rect><text x="177" y="368" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$20</text><text x="0" y="404" fill="var(--color-text)" font-size="14">Documenso</text><rect x="110" y="382" width="90" height="15" fill="var(--color-text-tertiary)" rx="1"></rect><text x="207" y="394" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$30</text><rect x="110" y="400" width="75" height="15" fill="var(--color-primary-600)" rx="1"></rect><text x="192" y="412" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$25</text><text x="0" y="448" fill="var(--color-text)" font-size="14">Novu</text><rect x="110" y="426" width="75" height="15" fill="var(--color-text-tertiary)" rx="1"></rect><text x="192" y="438" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$25</text><rect x="110" y="444" width="90" height="15" fill="var(--color-primary-600)" rx="1"></rect><text x="207" y="456" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$30</text><text x="0" y="492" fill="var(--color-text)" font-size="14">Dify</text><rect x="110" y="470" width="177" height="15" fill="var(--color-text-tertiary)" rx="1"></rect><text x="294" y="482" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$59</text><rect x="110" y="488" width="177" height="15" fill="var(--color-primary-600)" rx="1"></rect><text x="294" y="500" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$59</text><text x="0" y="536" fill="var(--color-text)" font-size="14">Metabase</text><rect x="110" y="514" width="255" height="15" fill="var(--color-text-tertiary)" rx="1"></rect><text x="372" y="526" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$85</text><rect x="110" y="532" width="300" height="15" fill="var(--color-primary-600)" rx="1"></rect><text x="417" y="544" fill="var(--color-text-secondary)" font-size="12" font-weight="600">$100</text></svg>
<figcaption>Entry price, 2023 vs 2026, for every tool with a comparable flat/seat price in both years (sorted by 2026 price). Verified against Wayback snapshots. Usage-priced tools (PostHog, ClickHouse) and tools unpriced in 2023 (Plane, Temporal) are excluded.</figcaption>
</figure>
